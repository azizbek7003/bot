...
async def check_subscription(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        if member.status in ["member", "administrator", "creator"]:
            ...
            # Obunani tekshirishda kanalga obuna bo'lgan foydalanuvchi uchun matn yuboring
            await query.edit_message_text(text="✅ Siz kanalga obuna bo'lgansiz! Endi matn yuboring:")
        else:
            context.user_data['is_subscribed'] = False
            # Obuna bo'lmagan foydalanuvchiga obuna bo'lishni taklif etish
...
async def translate_text(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if original_text:
        try:
            ...
            # Tarjimani yuborish va foydalanuvchiga yana matn yuborishni so'rash
            keyboard = [
